    ...
    <main className="bg-[#ECE3CE]">
      <div className="support-us-container bg-gray-100 rounded-md shadow-md max-w-4xl mx-auto p-8 mt-11 mb-11 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Image src={p1Photo} alt="Image 1" className="w-full h-full object-cover rounded-md" />
          <Image src={p2Photo} alt="Image 2" className="w-full h-full object-cover rounded-md" />
          <Image src={p3Photo} alt="Image 3" className="w-full h-full object-cover rounded-md" />
        </div>
      </div>
    </main>
  );
